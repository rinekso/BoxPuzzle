...
{
    [CreateAssetMenu(menuName = Paths.ScriptablePath.MapWindow)]
    public class MapWindowSettings : ScriptableObjectExtended
    {
        ...
        public const string DefaultPathRelative = Paths.ScriptablePath.Asset + "/Map Editor/Editor Resources/MapWindowSettings.asset";
